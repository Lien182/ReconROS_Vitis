...
module rt_imp_rt_imp_Pipeline_VITIS_LOOP_183_17 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign data_1_out = ((osif_sw2hw_read_nbread_fu_40_p2_0[0:0] == 1'b1) ? osif_sw2hw_dout : data_fu_36);

assign data_2_fu_81_p3 = ((osif_sw2hw_read_nbread_fu_40_p2_0[0:0] == 1'b1) ? osif_sw2hw_dout : data_fu_36);
...
endmodule //rt_imp_rt_imp_Pipeline_VITIS_LOOP_183_17
