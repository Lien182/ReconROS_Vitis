...
architecture behav of rt_imp_xfUDivResize is 
...
attribute shreg_extract : string;
    ...
    signal grp_fu_24_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal grp_fu_24_p2 : STD_LOGIC_VECTOR (32 downto 0);
    signal ap_CS_fsm_state46 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state46 : signal is "none";
    signal grp_fu_24_ap_start : STD_LOGIC;
    signal grp_fu_24_ap_done : STD_LOGIC;
    signal trunc_ln160_fu_30_p1 : STD_LOGIC_VECTOR (32 downto 0);
    signal ap_return_preg : STD_LOGIC_VECTOR (32 downto 0) := "000000000000000000000000000000000";
    ...
    signal grp_fu_24_p10 : STD_LOGIC_VECTOR (41 downto 0);
    signal ap_ce_reg : STD_LOGIC;

    component rt_imp_udiv_42ns_10ns_33_46_seq_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    udiv_42ns_10ns_33_46_seq_1_U58 : component rt_imp_udiv_42ns_10ns_33_46_seq_1
    generic map (
        ID => 1,
        NUM_STAGE => 46,
        din0_WIDTH => 42,
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_return_preg <= ap_const_lv33_0;
            else
    ...
    ap_return_assign_proc : process(ap_CS_fsm_state46, trunc_ln160_fu_30_p1, ap_return_preg)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state46)) then 
    ...
    grp_fu_24_p1 <= grp_fu_24_p10(10 - 1 downto 0);
    grp_fu_24_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(in_d),42));
    trunc_ln160_fu_30_p1 <= grp_fu_24_p2(33 - 1 downto 0);
end behav;
